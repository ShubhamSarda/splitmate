      ...
      <div className="page-app flex h-full items-center justify-between">
        ...
        {user && (
          <div ref={menuRef} className="relative">
            ...
            <div
              role="menu"
              className={`absolute right-0 top-full mt-1.5 w-48 overflow-hidden rounded-xl border border-line bg-surface transition-[opacity,transform] duration-150 ease-out ${
                open
                  ? "translate-y-0 opacity-100"
                  : "pointer-events-none -translate-y-1 opacity-0"
              }`}
              style={{ boxShadow: "0 8px 24px -4px rgba(28,25,23,0.12)" }}
            >
              <Link
                to="/profile"
                role="menuitem"
